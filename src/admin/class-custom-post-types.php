...
if (!class_exists(CustomPostTypes::class)) {
  class CustomPostTypes
  {
    ...
    public function __construct()
    {
      ...
      add_action('init', array($this, 'register_hubs'), 1);
    ...
    public function register_collections()
    {
      ...
      $args = array(
        ...
        'labels' => $labels,
        'supports' => array('title', 'thumbnail', 'revisions', 'page-attributes', 'editor', 'excerpt'),
        'hierarchical' => false,
        'public' => true,
        'show_in_rest' => true,
        'show_ui' => true,
     ...
     * Register collection post type
     */
    public function register_hubs()
    {
      $labels = array(
        'name' => TextDomain::_xw('Hubs'),
        'singular_name' => TextDomain::_xw('Hub'),
        'menu_name' => TextDomain::__w('Hubs'),
        'name_admin_bar' => TextDomain::__w('Hubs'),
        'archives' => TextDomain::__w('Hub Archives'),
        'attributes' => TextDomain::__w('Hub Attributes'),
        'parent_item_colon' => TextDomain::__w('Parent Hub:'),
        'all_items' => TextDomain::__w('All Hubs'),
        'add_new_item' => TextDomain::__w('Add New Hub'),
        'add_new' => TextDomain::__w('Add New'),
        'new_item' => TextDomain::__w('New Hub'),
        'edit_item' => TextDomain::__w('Edit Hub'),
        'update_item' => TextDomain::__w('Update Hub'),
        'view_item' => TextDomain::__w('View Hub'),
        'view_items' => TextDomain::__w('View Hub'),
        'search_items' => TextDomain::__w('Search Hub'),
        'not_found' => TextDomain::__w('Not found'),
        'not_found_in_trash' => TextDomain::__w('Not found in Trash'),
        'featured_image' => TextDomain::__w('Featured Image'),
        'set_featured_image' => TextDomain::__w('Set featured image'),
        'remove_featured_image' => TextDomain::__w('Remove featured image'),
        'use_featured_image' => TextDomain::__w('Use as featured image'),
        'insert_into_item' => TextDomain::__w('Insert into Hubs'),
        'uploaded_to_this_item' => TextDomain::__w('Uploaded to this Hub'),
        'items_list' => TextDomain::__w('Experiences list'),
        'items_list_navigation' => TextDomain::__w('Experiences list navigation'),
        'filter_items_list' => TextDomain::__w('Filter Hubs list'),
      );
      $rewrite = array(
        'slug' => '/hubs',
        'with_front' => true
      ...
      $args = array(
        'label' => TextDomain::__w('Hub'),
        'description' => TextDomain::__w('Posts for hubs'),
        'labels' => $labels,
        'supports' => array('title', 'thumbnail', 'revisions', 'page-attributes', 'editor', 'excerpt'),
        'hierarchical' => false,
        'public' => true,
        ...
        'capability_type' => 'post',
        'show_in_graphql' => true,
        'graphql_single_name' => 'Hub',
        'graphql_plural_name' => 'Hubs',
      );
