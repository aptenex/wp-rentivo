...
?>
      <script>
        ...
        window.apps.access_token = "<?php if ($access_token) {
                                      echo $access_token;
                                    } else {
                                      echo '';
                                    } ?>";
        window.apps.last_build_job_id = "<?php if ($last_build_job_id) {
                                            echo $last_build_job_id;
                                          } else {
                                            echo '';
                                          } ?>";
        window.apps.last_build_preview_job_id = "<?php if ($last_build_preview_job_id) {
                                                    echo $last_build_preview_job_id;
                                                  } else {
                                                    echo '';
                                                  } ?>";
