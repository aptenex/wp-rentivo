...
Contributors: rentivo
Donate link: https://www.rentivo.com/
Tags:
...
1. Install the plugin:
    1. Upload the `rentivo-simba.zip` file at wp-admin > Plugins > Add New menu
    1. Or, via SFTP, upload the `rentivo-simba` directory to the `/wp-content/plugins/` directory
1. Activate the plugin:
    1. Visit wp-admin > Plugins
    1. Find the `Rentivo Simba` plugin in the list
...
* Make sure to update the readme.txt header, the rentivo-simba.php header, and the `PLUGIN_VERSION` constant each time you release a new version.
